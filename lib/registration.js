...
function buildRegistrationPayload(info) {
  return {
    ...
    wsPath: info.wsPath || ('/' + websockifyPath(info.vncPort || 5900)),
    audioPort: info.audioPort || info.wsPort || 8840,
    audioPath: info.audioPath || '/audio',
    audioTransport: info.audioTransport || 'webrtc',
